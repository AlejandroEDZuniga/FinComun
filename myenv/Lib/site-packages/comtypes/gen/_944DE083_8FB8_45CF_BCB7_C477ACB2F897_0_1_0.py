...
__all__ = [
    ...
    'UIA_Selection2ItemCountPropertyId', 'NotificationProcessing',
    'UIA_TableRowOrColumnMajorPropertyId',
    'AutomationElementMode_Full', 'UIA_DockDockPositionPropertyId',
    'NotificationProcessing_All', 'UIA_UnderlineStyleAttributeId',
    'UIA_CustomLandmarkTypeId', 'IAccessible',
    'UIA_AnnotationDateTimePropertyId', 'UIA_StylesStyleIdPropertyId',
    'IUIAutomationGridItemPattern', 'TextUnit_Word',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_WindowIsTopmostPropertyId', 'UIA_LabeledByPropertyId',
    'TextUnit_Paragraph', 'TreeTraversalOptions',
    'IUIAutomationTransformPattern',
    'UIA_InputReachedOtherElementEventId', 'DockPosition',
    'ToggleState_Off', 'UIA_OverlineColorAttributeId',
    'AnnotationType_DataValidationError', 'TextUnit',
    'ProviderOptions_UseComThreading', 'UIA_LiveSettingPropertyId',
    'UIA_StructureChangedEventId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_DescribedByPropertyId', 'UIA_DragPatternId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_SizeOfSetPropertyId',
    'UIA_ClickablePointPropertyId', 'AutomationElementMode_None',
    'AnnotationType_Footer', 'IUIAutomationTextRange2',
    'UIA_LegacyIAccessibleRolePropertyId', 'ZoomUnit_LargeDecrement',
    'StyleId_Heading2', 'ExpandCollapseState_Collapsed',
    'ProviderOptions',
    ...
    'UIA_AnnotationObjectsAttributeId', 'TextPatternRangeEndpoint',
    'DockPosition_Top', 'UIA_LegacyIAccessibleSelectionPropertyId',
    ...
    'UIA_IsDragPatternAvailablePropertyId', 'UIA_TransformPatternId',
    ...
    'AnnotationType_SpellingError', 'UIA_MarginLeadingAttributeId',
    'TreeTraversalOptions_Default', 'UIA_ScrollPatternId',
    'HeadingLevel7', 'IUIAutomation3', 'DockPosition_Bottom',
    'UIA_MainLandmarkTypeId', 'AnnotationType_FormulaError',
    'StructureChangeType_ChildRemoved', 'StyleId_Normal',
    'AnnotationType_UnsyncedChange', 'UIA_VirtualizedItemPatternId',
    'Off', 'UIA_NavigationLandmarkTypeId', 'Polite',
    'WindowInteractionState_ReadyForUserInteraction',
    'NotificationKind', 'UIA_ListItemControlTypeId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'IUIAutomationTransformPattern2', 'NavigateDirection_NextSibling',
    ...
    'UIA_SpreadsheetItemPatternId', 'UIA_MarginTrailingAttributeId',
    'UIA_LevelPropertyId', 'UIA_IsGridPatternAvailablePropertyId',
    'ExtendedProperty', 'TextUnit_Line',
    'ExpandCollapseState_Expanded', 'UIA_DataItemControlTypeId',
    'UIA_UnderlineColorAttributeId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_TreeItemControlTypeId', 'TextUnit_Page',
    'AnnotationType_TrackChanges', 'IUIAutomationElement9',
    'UIA_DataGridControlTypeId', 'IUIAutomationRangeValuePattern',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'IUIAutomationTablePattern', 'HeadingLevel8',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_HyperlinkControlTypeId', 'ScrollAmount_NoAmount',
    'UIA_StyleIdAttributeId', 'TreeScope_Descendants',
    'StyleId_Custom', 'IUIAutomationDockPattern',
    'TreeTraversalOptions_PostOrder',
    'IUIAutomationDropTargetPattern', 'HeadingLevel5',
    'UIA_SelectionSelectionPropertyId', 'UIA_HelpTextPropertyId',
    'UIA_RuntimeIdPropertyId', 'UIA_BackgroundColorAttributeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_FlowsFromPropertyId', 'UIA_ForegroundColorAttributeId',
    'UIA_Drag_DragStartEventId',
    'UIA_AfterParagraphSpacingAttributeId',
    'AnnotationType_Mathematics', 'UIA_CaretPositionAttributeId',
    'UIA_IsDialogPropertyId', 'UIA_AutomationFocusChangedEventId',
    'UIA_FillColorPropertyId', 'UIA_SynchronizedInputPatternId',
    'UIA_DropTargetDropTargetEffectPropertyId', 'ScrollAmount',
    'NavigateDirection_LastChild', 'UIA_ButtonControlTypeId',
    'NavigateDirection_FirstChild', 'UIA_CustomNavigationPatternId',
    'StyleId_Heading1', 'UIA_IsSelectionPattern2AvailablePropertyId',
    'LiveSetting', 'NotificationProcessing_CurrentThenMostRecent',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_GridItemPatternId', 'SynchronizedInputType_RightMouseUp',
    'NotificationKind_ActionAborted', 'UIA_ToolTipClosedEventId',
    'TextEditChangeType_Composition',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'ScrollAmount_LargeDecrement', 'UIA_AutomationIdPropertyId',
    'UIA_IsRequiredForFormPropertyId', 'AnnotationType_Header',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'ProviderOptions_RefuseNonClientSupport',
    'StructureChangeType_ChildAdded',
    'UIA_IsValuePatternAvailablePropertyId', 'UIA_MenuOpenedEventId',
    'IUIAutomationElement6', 'UIA_TableRowHeadersPropertyId',
    'UIA_IndentationLeadingAttributeId', 'AnnotationType_Author',
    'UIA_InputDiscardedEventId', 'UIA_ToggleToggleStatePropertyId',
    'UIA_ProgressBarControlTypeId',
    'IUIAutomationProxyFactoryMapping', 'WindowVisualState_Maximized',
    'HeadingLevel9', 'UIA_SystemAlertEventId',
    'IUIAutomationAndCondition', 'UIA_IsPeripheralPropertyId',
    'IUIAutomationExpandCollapsePattern',
    'StructureChangeType_ChildrenReordered',
    'IUIAutomationAnnotationPattern', 'IUIAutomation',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_StylesShapePropertyId', 'UIA_MenuModeEndEventId',
    'TextEditChangeType', 'NotificationProcessing_MostRecent',
    'UIA_AnnotationTypesPropertyId', 'TreeScope',
    ...
    'UIA_ToolTipControlTypeId', 'StyleId_Heading8',
    'UIA_ImageControlTypeId', 'UIA_IsKeyboardFocusablePropertyId',
    'IUIAutomation2', 'IUIAutomationItemContainerPattern',
    'UIA_ItemStatusPropertyId', 'AnnotationType_MoveChange',
    ...
    'UIA_LegacyIAccessibleStatePropertyId', 'UIA_GroupControlTypeId',
    'StyleId_Heading6', 'UIA_AppBarControlTypeId',
    'ProviderOptions_OverrideProvider', 'StyleId_Quote',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_Transform2ZoomLevelPropertyId',
    'ProviderOptions_UseClientCoordinates',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_SpinnerControlTypeId',
    'StyleId_Heading5', 'UIA_DropTarget_DragEnterEventId',
    'UIA_AnnotationTargetPropertyId',
    'UIA_TransformCanMovePropertyId',
    'IUIAutomationCustomNavigationPattern', 'UIA_HeaderControlTypeId',
    'UIA_CultureAttributeId', 'UIA_NotificationEventId',
    'UIA_IsDataValidForFormPropertyId', 'AnnotationType_Highlighted',
    'IUIAutomation4', 'UIA_SplitButtonControlTypeId',
    'UIA_CapStyleAttributeId', 'HeadingLevel6',
    'UIA_SelectionItemIsSelectedPropertyId',
    'IUIAutomationEventHandler', 'UIA_DragIsGrabbedPropertyId',
    'StructureChangeType', 'DockPosition_Left', 'UIA_TextPattern2Id',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_SelectionItemPatternId', 'RowOrColumnMajor_RowMajor',
    ...
    'UIA_IsReadOnlyAttributeId', 'IUIAutomationElement3',
    'NotificationKind_ActionCompleted',
    'IUIAutomationObjectModelPattern', 'WindowVisualState',
    'UIA_IsTogglePatternAvailablePropertyId',
    'IUIAutomationPropertyChangedEventHandler', 'UIA_DockPatternId',
    'IUIAutomationTogglePattern', 'ZoomUnit', 'AutomationElementMode',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_NamePropertyId', 'PropertyConditionFlags_MatchSubstring',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'IUIAutomationElement8', 'UIA_DropTarget_DroppedEventId',
    'UIA_CenterPointPropertyId', 'UIA_MenuClosedEventId',
    'UIA_LineSpacingAttributeId', 'UIA_IsSubscriptAttributeId',
    'UIA_WindowIsModalPropertyId', 'CUIAutomation8',
    'UIA_Window_WindowClosedEventId', 'UiaChangeInfo',
    'OrientationType_None', 'IUIAutomationElement5',
    'UIA_LiveRegionChangedEventId',
    'AnnotationType_AdvancedProofingIssue', 'HeadingLevel_None',
    'IUIAutomationOrCondition', 'UIA_FlowsToPropertyId',
    ...
    'IUIAutomationValuePattern', 'DockPosition_Fill',
    'IUIAutomationInvokePattern', 'ScrollAmount_SmallDecrement',
    'UIA_IsContentElementPropertyId',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'AnnotationType_CircularReferenceError', 'AnnotationType_Comment',
    'WindowVisualState_Normal', 'UIA_TextPatternId',
    'UIA_LocalizedControlTypePropertyId', 'UIA_IsItalicAttributeId',
    'UIA_TransformPattern2Id',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_Selection_InvalidatedEventId', 'IUIAutomationCondition',
    'IUIAutomation5', 'AnnotationType_Unknown',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'AnnotationType_DeletionChange', 'NotificationKind_Other',
    'UIA_ComboBoxControlTypeId', 'UIA_WindowPatternId',
    'IUIAutomationTextPattern2', 'UIA_FrameworkIdPropertyId',
    'IUIAutomationElement7', 'StructureChangeType_ChildrenBulkAdded',
    'AnnotationType_EditingLockedChange',
    'UIA_IsTextPatternAvailablePropertyId', 'StyleId_BulletedList',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_AsyncContentLoadedEventId', 'CoalesceEventsOptions',
    'NavigateDirection_PreviousSibling',
    'IUIAutomationTextChildPattern',
    'TextEditChangeType_CompositionFinalized',
    'UIA_SearchLandmarkTypeId', 'StyleId_Emphasis',
    'UIA_IsTablePatternAvailablePropertyId', 'UIA_MenuControlTypeId',
    'IUIAutomationTextRange3', 'UIA_PaneControlTypeId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_ObjectModelPatternId',
    'IUIAutomationElement2', 'ProviderOptions_ClientSideProvider',
    'UIA_WindowCanMaximizePropertyId', 'IUIAutomationTreeWalker',
    'ProviderOptions_ProviderOwnsSetFocus', 'TextUnit_Format',
    'IUIAutomationElementArray', 'SynchronizedInputType_LeftMouseUp',
    'UIA_RadioButtonControlTypeId',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_ClassNamePropertyId',
    'ToggleState_Indeterminate', 'IUIAutomationSelectionPattern2',
    'StyleId_Title', 'IUIAutomationChangesEventHandler',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_AnnotationTypesAttributeId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_TabItemControlTypeId', 'ZoomUnit_LargeIncrement',
    ...
    'IUIAutomationTableItemPattern', 'IUIAutomationSelectionPattern',
    'UIA_ControllerForPropertyId', 'UIA_CaretBidiModeAttributeId',
    'IUIAutomationGridPattern', 'UIA_IsPasswordPropertyId',
    'ExpandCollapseState', 'SupportedTextSelection_None',
    'UIA_FillTypePropertyId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId', 'ToggleState_On',
    'StructureChangeType_ChildrenInvalidated',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_DragGrabbedItemsPropertyId', 'CoalesceEventsOptions_Enabled',
    'UIA_OrientationPropertyId', 'OrientationType_Vertical',
    'DockPosition_None', 'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId', 'Assertive',
    'UIA_StyleNameAttributeId',
    'IUIAutomationSynchronizedInputPattern',
    'OrientationType_Horizontal', 'UIA_TablePatternId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_MenuBarControlTypeId', 'TreeScope_None',
    'TextEditChangeType_AutoComplete', 'UIA_TabControlTypeId',
    'UIA_IsSuperscriptAttributeId', 'UIA_AnimationStyleAttributeId',
    'UIA_MarginBottomAttributeId', 'StyleId_NumberedList',
    'IUIAutomationSpreadsheetItemPattern',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_IsOffscreenPropertyId', 'DockPosition_Right',
    'UIA_MultipleViewPatternId', 'UIA_ToolTipOpenedEventId',
    'TextEditChangeType_AutoCorrect',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_NativeWindowHandlePropertyId', 'TextUnit_Character',
    'UIA_GridPatternId', 'UIA_HostedFragmentRootsInvalidatedEventId',
    'PropertyConditionFlags_None', 'UIA_TextChildPatternId',
    'UIA_ScrollItemPatternId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'IUIAutomationCacheRequest', 'ScrollAmount_LargeIncrement',
    'SynchronizedInputType_KeyDown', 'WindowInteractionState_Running',
    'IUIAutomationEventHandlerGroup', 'WindowVisualState_Minimized',
    'AnnotationType_Endnote', 'UIA_MultipleViewCurrentViewPropertyId',
    'ExpandCollapseState_LeafNode', 'HeadingLevel3',
    'UIA_CulturePropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId', 'TreeScope_Subtree',
    'IUIAutomationStylesPattern', 'UIA_Window_WindowOpenedEventId',
    'UIA_GridRowCountPropertyId', 'UIA_RangeValueMinimumPropertyId',
    'UIA_GridItemColumnPropertyId', 'TreeScope_Children',
    'UIA_FontWeightAttributeId', 'TreeScope_Ancestors',
    'SupportedTextSelection_Multiple', 'TextEditChangeType_None',
    'UIA_LegacyIAccessiblePatternId', 'SynchronizedInputType_KeyUp',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'PropertyConditionFlags_IgnoreCase', 'UIA_SelectionPatternId',
    'UIA_OutlineColorPropertyId', 'UIA_HeaderItemControlTypeId',
    'UIA_ItemContainerPatternId', 'UIA_FormLandmarkTypeId',
    'UIA_Drag_DragCompleteEventId', 'TreeScope_Parent',
    'UIA_SemanticZoomControlTypeId', 'RowOrColumnMajor_Indeterminate',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'IUIAutomationTextRangeArray',
    'UIA_ProviderDescriptionPropertyId', 'OrientationType',
    'UIA_SpreadsheetPatternId', 'UIA_TreeControlTypeId',
    'CUIAutomation', 'UIA_StrikethroughColorAttributeId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'WindowInteractionState_Closing',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_StatusBarControlTypeId', 'UIA_SelectionActiveEndAttributeId',
    'StyleId_Subtitle', 'UIA_TogglePatternId',
    'IUIAutomationScrollItemPattern',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_AccessKeyPropertyId', 'UIA_MarginTopAttributeId',
    'UIA_RotationPropertyId', 'IUIAutomationDragPattern',
    'UIA_InvokePatternId', 'AnnotationType_ExternalChange',
    ...
    'TextPatternRangeEndpoint_End', 'UIA_BoundingRectanglePropertyId',
    'UIA_RangeValuePatternId', 'HeadingLevel4',
    'UIA_MenuModeStartEventId', 'HeadingLevel1',
    'UIA_ToolBarControlTypeId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_IndentationTrailingAttributeId',
    'UIA_LandmarkTypePropertyId', 'IUIAutomationMultipleViewPattern',
    'UIA_IsTableItemPatternAvailablePropertyId', 'StyleId_Heading3',
    'UIA_DragDropEffectsPropertyId', 'UIA_AnnotationAuthorPropertyId',
    'AnnotationType_InsertionChange',
    'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_CalendarControlTypeId', 'UIA_AnnotationObjectsPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_LayoutInvalidatedEventId', 'SynchronizedInputType',
    'UIA_TableColumnHeadersPropertyId',
    'WindowInteractionState_NotResponding',
    'IUIAutomationProxyFactory', 'UIA_SelectionPattern2Id',
    'UIA_OutlineStylesAttributeId', 'UIA_GridColumnCountPropertyId',
    'UIA_DropTargetPatternId', 'HeadingLevel2',
    'UIA_CheckBoxControlTypeId', 'UIA_FullDescriptionPropertyId',
    ...
    'UIA_AnnotationPatternId', 'UIA_ProcessIdPropertyId',
    'ZoomUnit_NoAmount', 'UIA_SayAsInterpretAsMetadataId',
    'UIA_SizePropertyId', 'TextPatternRangeEndpoint_Start',
    'IUIAutomationSpreadsheetPattern', 'UIA_OverlineStyleAttributeId',
    'IUIAutomationNotificationEventHandler',
    'NavigateDirection_Parent',
    'UIA_IsInvokePatternAvailablePropertyId',
    'IRawElementProviderSimple', 'UIA_TextEditPatternId',
    'PropertyConditionFlags', 'UIA_StylesStyleNamePropertyId',
    'UIA_WindowControlTypeId', 'UIA_IsEnabledPropertyId',
    'UIA_IsActiveAttributeId', 'TreeScope_Element',
    'UIA_Text_TextChangedEventId', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_ThumbControlTypeId', 'RowOrColumnMajor_ColumnMajor',
    'WindowInteractionState',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_FontNameAttributeId', 'UIA_AutomationPropertyChangedEventId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_DragDropEffectPropertyId', 'UIA_StylesFillColorPropertyId',
    'UIA_TransformCanRotatePropertyId', 'UIA_Drag_DragCancelEventId',
    ...
    'UIA_BeforeParagraphSpacingAttributeId', 'SupportedTextSelection',
    'TextUnit_Document', 'NavigateDirection',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_Invoke_InvokedEventId', 'IUIAutomationScrollPattern',
    'ZoomUnit_SmallDecrement', 'UIA_AcceleratorKeyPropertyId',
    'IUIAutomationTextRange',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'NotificationKind_ItemRemoved', 'UIA_DocumentControlTypeId',
    'UIA_StylesPatternId', 'SynchronizedInputType_LeftMouseDown',
    'UIA_FontSizeAttributeId', 'IUIAutomationProxyFactoryEntry',
    'UIA_SummaryChangeId', 'UIA_TextControlTypeId',
    'IUIAutomationElement4', 'IUIAutomationFocusChangedEventHandler',
    'UIA_TabsAttributeId', 'UIA_ListControlTypeId',
    'IUIAutomationTextEditPattern', 'StyleId_Heading9',
    'IUIAutomation6', 'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_LinkAttributeId', 'UIA_AriaRolePropertyId',
    'RowOrColumnMajor', 'UIA_ScrollBarControlTypeId',
    'NotificationProcessing_ImportantAll', 'UIA_TableItemPatternId',
    'IUIAutomationTextPattern',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_ChangesEventId', 'UIA_IsControlElementPropertyId',
    'UIA_HorizontalTextAlignmentAttributeId', 'StyleId_Heading7',
    'UIA_TableControlTypeId', 'UIA_DropTarget_DragLeaveEventId',
    'IUIAutomationWindowPattern',
    'SynchronizedInputType_RightMouseDown',
    'UIA_PositionInSetPropertyId', 'AnnotationType_GrammarError',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_AriaPropertiesPropertyId'
]

_check_version('1.2.0', 1536995528.869254)
