...
__all__ = [
    'OLE_XPOS_PIXELS', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_HIMETRIC',
    'Default', 'Color', 'OLE_OPTEXCLUSIVE', 'Picture', 'OLE_HANDLE',
    'FONTBOLD', 'IFontEventsDisp', 'OLE_TRISTATE', 'IFontDisp',
    'OLE_XPOS_HIMETRIC', 'FONTSTRIKETHROUGH', 'StdPicture', 'StdFont',
    'OLE_XSIZE_HIMETRIC', 'VgaColor', 'IPicture',
    'LoadPictureConstants', 'OLE_CANCELBOOL', 'OLE_COLOR',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_CONTAINER', 'Unchecked',
    'Gray', 'OLE_XPOS_CONTAINER', 'OLE_YPOS_CONTAINER', 'FONTITALIC',
    'OLE_YSIZE_HIMETRIC', 'Monochrome', 'OLE_YPOS_PIXELS',
    'IPictureDisp', 'IFont', 'FONTSIZE', 'OLE_YSIZE_PIXELS',
    'FontEvents', 'Font', 'FONTUNDERSCORE', 'FONTNAME', 'Checked',
    'OLE_YSIZE_CONTAINER'
]

_check_version('1.2.0', 1536995557.925106)
